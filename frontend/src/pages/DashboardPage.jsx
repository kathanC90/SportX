...
const UserDashboard = () => {
  ...
  useEffect(() => {
    ...
    if (!isSignedIn) {
      ...
      setLoading(false); // Remove unnecessary delay
    }
  ...
  return (
    <div className="w-full min-h-screen bg-gray-50">
      ...
      {/* Hero Section */}
      <motion.div
        className="bg-gradient-to-r from-yellow-400 to-orange-500 p-10 flex flex-col md:flex-row items-center text-center md:text-left rounded-lg shadow-lg mx-4"
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
      >
        <div className="ml-0 md:ml-10">
          ...
          <motion.button
            className="bg-black text-white px-6 py-2 mt-4 rounded-lg hover:bg-gray-900 transition"
      ...
      {/* Products Grid */}
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 mt-6 px-6">
          ...
          >
            ...
            <div className="flex gap-2 mt-2">
              ...
              <Link
                ...
                className="bg-gray-700 text-white w-full py-2 rounded-md hover:bg-gray-600 transition text-center"
              >
                View
              </Link>
            </div>
